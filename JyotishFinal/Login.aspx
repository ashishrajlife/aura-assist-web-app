<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="Login.aspx.cs" Inherits="Login" Title="Jyotish - Login" %>
...
<style>
  ...
  /* Validator messages */
  .form-group span[id*="rfv"],
  .form-group span[id*="rev"] {
  ...
  <div class="auth-box">
    ...
    <div class="form-group">
      ...
      <asp:TextBox ID="txtPassword" runat="server" TextMode="Password"
        placeholder="Your password" MaxLength="255" />
    ...
    <!-- Submit -->
    <asp:Button ID="btnLogin" runat="server" Text="Enter the Cosmos"
      CssClass="btn btn-gold btn-full" OnClick="btnLogin_Click" />

    <div class="switch" style="margin-top:20px;">
      New here? &nbsp;<a href="Register.aspx">Create Account</a>
    </div>
